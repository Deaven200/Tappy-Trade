    ...
    container.innerHTML = `
        <div class="panel">
            ...
            <div style="margin-bottom:10px">
                <div><b>Tap Plot</b>: Harvest resources</div>
                <div><b>Hold Plot (empty)</b>: Build menu</div>
                <div><b>Hold Plot (built)</b>: Upgrade menu</div>
                <div><b>Tap Market</b>: Buy/Sell items</div>
                <div><b>Tap Inventory</b>: View items / Use items</div>
            </div>
